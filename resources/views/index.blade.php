...
@section('content')
    ...
    <head>
        ...
        <meta name="description"
            content="Soluciones web personalizadas para impulsar tu presencia en línea y alcanzar el éxito digital.">
        <?php else : ?>
    ...
    <body>
        ...
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5CDNJTBN" height="0" width="0"
        ...
        <header>
            <nav class="nav">
                <div class="logo">
                    <a href="/"><img id="logo" src="{{ asset('images/logo/texto-logo-v2.png') }}"
                            alt="logo of system" /></a>
                </div>
        ...
        <main>
            ...
            <section class="servicio" id="servicios">
                ...
                <div class="d-flex flex-column gap-2 justify-content-center mt-5">
                    ...
                    <div class="tab-servicio d-flex w-100 flex-wrap">
                        @foreach ($servicios as $servicio)
                            <div id="categories-{{ $servicio->id }}"
                                class="categories d-flex w-100 justify-content-evenly d-none gap-4 p-3 flex-wrap">
                                @foreach ($servicio->categorias as $categoria)
                                    <div class="d-flex gap-2 flex-column col tarjeta justify-content-between animate__animated animate__fadeIn"
                                        data-aos="zoom-in">
                                        @if ($categoria->plan->view_descuento)
                                            <div class="offer-badge">-&nbsp;{{ $categoria->plan->descuento }}%</div>
                                        @endif
                                        <div class="card-cuerpo">
                                            <div class="card-categoria mb-4">
                                                <h2>
                                                    @if ($current_language == 'es')
                                                        {{ $categoria->nombre_es }}
                                                    @else
                                                ...
                                                <p class="m-0 placeholder-2" style="font-size: 16px !important;">
                                                    @if ($current_language == 'es')
                                                        {{ $categoria->descripcion_es }}
                                                    @else
                                                        {{ $categoria->descripcion_en }}
                                                    @endif
                                                </p>
                                            </div>
                                            @if ($categoria->plan->view_precio)
                                                <div class="monto mb-4 pe-4 text-center">
                                                    <span class="h1 monto tertiary"><sup
                                                            ...
                                                            @else
                                                                {{ $categoria->plan->monto_final_en }}
                                                            @endif

                                                        </span>
                                                    </h1>
                                                    <p class="m-0 placeholder-2" style="font-size: 14px !important;">
                                                        @if ($categoria->plan->view_descuento)
                                                            <?php echo $translations['precio_anterior']; ?>
                                                            <del>&nbsp;<?php echo $translations['icono_moneda']; ?>&nbsp;
                                                                @if ($current_language == 'es')
                                                                    {{ $categoria->plan->precio_es }}
                                                                @else
                                                                    {{ $categoria->plan->precio_en }}
                                                                @endif
                                            ...
                                            <hr class="mb-4">
                                            <div class="card-plan">
                                                <ul class="custom-list placeholder-2">
                                                    @if ($categoria->plan->paginas && $categoria->plan->paginas > 0)
                                                        <li>
                                                            <p><?php echo $translations['paginas']; ?>{{ $categoria->plan->paginas }}</p>
                                                        </li>
                                                    @endif
                                                    @if ($categoria->plan->secciones && $categoria->plan->secciones > 0)
                                                        <li>
                                                            <p><?php echo $translations['secciones']; ?>{{ $categoria->plan->secciones }}</p>
                                                        </li>
                                                    @endif
                                                    @if ($categoria->plan->cant_correos && $categoria->plan->cant_correos > 0)
                                                        <li>
                                                            <p><?php echo $translations['correos_corporativos']; ?>
                                                                {{ $categoria->plan->cant_correos }}&nbsp;<sup
                                                                    style="font-size: 14px;">(*)</sup>
                                                            </p>
                                                        </li>
                                                    @endif
                                                    @if ($categoria->plan->cant_productos && $categoria->plan->cant_productos > 0)
                                                        <li>
                                                            <p><?php echo $translations['productos_iniciales']; ?>{{ $categoria->plan->cant_productos }}
                                                            </p>
                                                        </li>
                                                    @endif
                                                    <li>
                                                        <p><?php echo $translations['conexion_wpp']; ?></p>
                                                    </li>
                                                    <li>
                                                        <p><?php echo $translations['posicion_seo']; ?></p>
                                                    </li>
                                                    <li>
                                                        <p><?php echo $translations['hosting_dominio']; ?>&nbsp;<sup
                                                                style="font-size: 14px;">(*)</sup>
                                                        </p>
                                                    </li>
                                                    <li>
                                                        <p><?php echo $translations['optimizacion_carga']; ?></p>
                                                    </li>
                                                    <li>
                                                        <p><?php echo $translations['seguridad']; ?>&nbsp;<sup
                                                                style="font-size: 14px;">(*)</sup></p>
                                                    </li>
                                                    <li>
                                                        <p><?php echo $translations['soporte_capacitacion']; ?></p>
                                                    </li>
                                                </ul>
                                            </div>
                                            <hr class="mt-4">
                                            <div>
                                                <p class="m-0 placeholder-2" style="font-size: 14px !important;">
                                                    <sup style="font-size: 10px;">(*)</sup>&nbsp;<?php echo $translations['uso_gratuito']; ?>
                                                    @if ($categoria->plan->view_renovacion)
                                                        <br><sup
                                                            style="font-size: 10px;">(**)</sup>&nbsp;<?php echo $translations['renovacion']; ?><?php echo $translations['icono_moneda']; ?>&nbsp;
                                                        @if ($current_language == 'es')
                                                            {{ $categoria->plan->renovacion_es }}
                                                        @else
                                                            {{ $categoria->plan->renovacion_en }}
                                                        @endif
                                                    @endif
                                                </p>
                                            </div>
                                        ...
                                        <div class="footer-card d-flex justify-content-start">
                                            <div class="btn-contacto">
                                                <a href="#contacto" class="btn-2" data-id-service="{{ $servicio->id }}" data-id-catego="{{ $categoria->id }}"><?php echo $translations['selec_plan']; ?></a>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                                <div class="d-flex gap-2 flex-column col tarjeta justify-content-center align-items-center animate__animated animate__fadeIn"
                                    data-aos="zoom-in">
                                    <div class="card-cuerpo">
                                        <div class="card-categoria mb-4 text-center">
                                            <h2><?php echo $translations['opc_personalizado']; ?></h2>
                                        </div>
                                        <div class="btn-contacto d-flex justify-content-center my-5">
                                            <a href="#contacto" class="btn-2" data-id-service="{{ $servicio->id }}" data-id-catego="1"><?php echo $translations['selec_plan']; ?></a>
                                        </div>
                                        <hr class="mb-3">
                                        <div class="monto mb-4 text-center">
                                            <p class="m-0 placeholder-2" style="font-size: 16px !important;">
                                                @if ($current_language == 'es')
                                                    {{ $servicio->descripcion_es }}
                                                @else
            ...
            <section class="contacto" id="contacto">
                <div class="espaciado center sec-contacto">
                    ...
                    <form method="post" id="formContacto"
                        ...
                        <input type="text" name="name" id="name" class="col-md-5 col-12" <?php if ($current_language == 'es') : ?>
                            placeholder="Nombre" <?php else : ?> placeholder="Name" <?php endif; ?> required />
                        <input type="email" name="email" id="email" class="col-md-5 col-12" <?php if ($current_language == 'es') : ?>
                            placeholder="Correo" <?php else : ?> placeholder="Email" <?php endif; ?> required />
                        <input type="hidden" name="plan" id="plan" data-id-service="1" data-id-catego="1"/>
                        <button type="submit" class="btn-3 col-md-1 col-5" data-bs-toggle="tooltip" data-bs-placement="bottom"
                        data-bs-title="<?php echo $translations['enviar']; ?>">
