...
<html lang="es">
	...
	<head>
		<title>Bryan Morán 😎</title>
		<meta name="viewport"
			content="width=device-width, initial-scale=1, shrink-to-fit=no">
		<!--metadatos-->
		<meta name="title" content="Bryan A. Morán Vega">
		<meta http-equiv="cache-control" content="no-cache">
		<meta name="description"
			content="Software & Full Stack Developer - Ingeniero de Sistemas.">
		<meta name="keywords"
		...
		<!--íconos de la web-->
		<script src="https://kit.fontawesome.com/1f84f73194.js"
		...
		<script
			...
			crossorigin="anonymous"></script>
		<!--icono, css, js-->
		<link rel="icon" href="{{ asset('images\logo\moran.ico')}}">
		<link
	...
	<body>
		<div class="wrapper">
			<div class="profile-card js-profile-card">
				<div class="profile-card__img">
					<img src="{{ asset('images/moran/avatar.webp')}}" alt="profile card">
				</div>

				<div class="profile-card__cnt js-profile-cnt">
					<div class="profile-card__name">Bryan Morán Vega</div>
					<div class="profile-card__txt">Software & Full Stack Developer<br>Ingeniero
						de Sistemas</div>
			  ...
			  <div class="profile-card-inf__item">
				...
				<div class="profile-card-inf__txt">Works</div>
					...
					<div class="profile-card-social">
						<a href="https://www.facebook.com/moran.vega24"
						...
						<a href="https://www.linkedin.com/in/moran-vega24/"
							class="profile-card-social__item linkedin" target="_blank">
							<span class="icon-font">
						...
						<a href="https://www.twitter.com/moran_vega24"
						...
						<a href="https://ofsystem.com.pe" class="profile-card-social__item link"
							target="_blank">
							<span class="icon-font">
					...
					<div class="profile-card-ctr">
						{{-- <a href="https://bryleo2009.github.io/CV/"
							class="profile-card__button button--blue" target="_blank">CV Virtual</a> --}}
						<a href="mailto:bryan.moran_vega@hotmail.com"
							class="profile-card__button button--orange" target="_blank">E-mail</a>
					</div>
				</div>
		...
		<script>
				$(function() {
					...
					headerTitle: 'Bryan Morán 😎', //Popup Titulo
