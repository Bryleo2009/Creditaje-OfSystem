!(function (v) {
  v.fn.floatingWhatsApp = function (e) {
    ...
    function C() {
        //obten dimencion de pantalla
        // var width = window.innerWidth;
        // var height = window.innerHeight;
        // //si la altura es menor o igual a 768px
        // if (height <= 768) {
        //     //redirecciona a la pagina de whatsapp
        //     i.menssage = "Hola, tengo una consulta"
        //     window.location.href = "https://api.whatsapp.com/send?phone=" + i.phone + "&text=" + encodeURI(i.message);
        // } else {
            if(i.message){
                var e = "http://";
                (e += o ? "api" : "api"),
    ...
    i.zIndex && v(this).css("z-index", i.zIndex),
      "right" === i.position &&
        (this.css({ left: "auto", right: i.rightPosition, bottom: i.bottomPosition }), l.css("right", "0"));
  };
})(jQuery);
