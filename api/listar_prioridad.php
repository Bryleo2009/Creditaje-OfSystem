...
// Hacer un select a mi tabla ticket_prioridad aquellos que tengan estado 1 y devolver los datos en formato JSON
$sql = "SELECT * FROM tb_ticket_prioridad WHERE estado = 1";
